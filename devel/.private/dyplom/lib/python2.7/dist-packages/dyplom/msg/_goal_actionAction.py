...
"""autogenerated by genpy from dyplom/goal_actionAction.msg. Do not edit."""
import codecs
import sys
...
class goal_actionAction(genpy.Message):
  _md5sum = "843f453112a27c465224fcb5df481ffb"
  _type = "dyplom/goal_actionAction"
...
"""
  ...
  _slot_types = ['dyplom/goal_actionActionGoal','dyplom/goal_actionActionResult','dyplom/goal_actionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(goal_actionAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = dyplom.msg.goal_actionActionGoal()
      if self.action_result is None:
        self.action_result = dyplom.msg.goal_actionActionResult()
      if self.action_feedback is None:
        self.action_feedback = dyplom.msg.goal_actionActionFeedback()
    else:
      self.action_goal = dyplom.msg.goal_actionActionGoal()
      self.action_result = dyplom.msg.goal_actionActionResult()
      self.action_feedback = dyplom.msg.goal_actionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.action_feedback.feedback.a, _x.action_feedback.feedback.b))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_feedback.feedback.a, _x.action_feedback.feedback.b,) = _get_struct_2d().unpack(str[start:end])
      return self
