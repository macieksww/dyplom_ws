...
"""autogenerated by genpy from dyplom/goal_actionActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class goal_actionActionFeedback(genpy.Message):
  _md5sum = "d98a8516f2a3eb157437e2ed60fc2e33"
  _type = "dyplom/goal_actionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dyplom/goal_actionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(goal_actionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dyplom.msg.goal_actionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dyplom.msg.goal_actionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.feedback.a, _x.feedback.b))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.a, _x.feedback.b,) = _get_struct_2d().unpack(str[start:end])
      return self
