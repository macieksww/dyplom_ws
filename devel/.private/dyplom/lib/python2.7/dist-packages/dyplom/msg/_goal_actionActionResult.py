...
"""autogenerated by genpy from dyplom/goal_actionActionResult.msg. Do not edit."""
import codecs
import sys
...
class goal_actionActionResult(genpy.Message):
  _md5sum = "9837ccbad3be3688f11b9241755315de"
  _type = "dyplom/goal_actionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dyplom/goal_actionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(goal_actionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dyplom.msg.goal_actionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dyplom.msg.goal_actionResult()
