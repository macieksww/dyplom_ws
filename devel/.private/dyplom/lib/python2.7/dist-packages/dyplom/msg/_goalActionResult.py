...
"""autogenerated by genpy from dyplom/goalActionResult.msg. Do not edit."""
import codecs
import sys
...
class goalActionResult(genpy.Message):
  _md5sum = "9837ccbad3be3688f11b9241755315de"
  _type = "dyplom/goalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dyplom/goalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(goalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dyplom.msg.goalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dyplom.msg.goalResult()
